...
heading.innerText = "👑People of GOT"
heading.style.fontSize = "2rem"
heading.style.fontWeight = "500"
rootElement.append(heading)
rootElement.style.color = "white"
rootElement.style.backgroundColor = "rgb(64,117,213)"
...
//   <ul class="container">
//   <li class="box">
//     <img src="https://raw.githubusercontent.com/nnnkit/json-data-collections/master/game-of-thrones/game-of-thrones-eddard-stark.jpg", alt="image">
//     <h2>'Eddard "Ned" Stark'</h2>
//     <p>"Lord of Winterfell - Warden of the North - Hand of the King - Married to Catelyn (Tully) Stark"</p>
//     <a href="http://gameofthrones.wikia.com/wiki/Eddard_Stark">Learn More!</a>
//   </li> 
// </ul>
// </div> 
...
got.houses.forEach((p)=>{
  ...
  img.style.border= "2px solid rgb(85, 121, 85)"
  img.src = elm.image
  ...
  btn.style.color = "rgb(108,160,248)"
